"use client";
import React, { HTMLProps, ReactNode, SVGProps, useRef } from "react";
import {
  motion,
  useAnimationFrame,
  useMotionTemplate,
...
type ButtonProps = {
  ...
  as?: React.ElementType; // Replace any with React.ElementType for the component type
  containerClassName?: string;
  borderClassName?: string;
  duration?: number;
  className?: string;
} & HTMLProps<HTMLElement>; // Use HTMLProps to type otherProps
